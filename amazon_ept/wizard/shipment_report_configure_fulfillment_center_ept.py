...
class ShipmentReportConfigureFulfillmentCenterEPT(models.TransientModel):
    ...
    def default_get(self, fields):
        """
        Load data in wizard of Missing Fulfillmet Center
        ...
        fulfillment_center_list = shipment_report_id.get_missing_fulfillment_center(shipment_report_id.attachment_id)
